...
本文把 **已经跑完的 WebGAP 第一轮** 和 **评测空间重设计** 写成同一条线。不是第二个项目，也不作废现有检查点。下载与训练按 [BENCHMARK_SURVEY.md](BENCHMARK_SURVEY.md) 的 P1 清单执行；**本文锁定做什么、不做什么、表怎么排**。P0–P6 已完成（P6 为负结果）。P8 **进行中**。最新停点见仓库根目录 [交接文档.md](../交接文档.md)。
...
**当前进度以仓库根目录 [交接文档.md](../交接文档.md) 为准。** P0–P6 已完成（P6 冲突门控为负结果）。P8 正在跑 `run_p8.py`。不要重跑 P3/P4/P5/P6，不要下 30B。
